...
const demoEmergencyInfo: HandbookContentProps["emergencyInfo"] = {
  ...
  breaker_panel: [
    { position: 0, label: "MAIN", amperage: 200, type: "double" as const, rooms: [], isMain: true },
    { position: 1, label: "Kitchen Outlets", amperage: 20, type: "single" as const, rooms: ["Kitchen"], isMain: false },
    { position: 2, label: "Kitchen Lights", amperage: 15, type: "single" as const, rooms: ["Kitchen"], isMain: false },
    { position: 3, label: "Dishwasher", amperage: 20, type: "single" as const, rooms: ["Kitchen"], isMain: false },
    { position: 4, label: "Garbage Disposal", amperage: 15, type: "single" as const, rooms: ["Kitchen"], isMain: false },
    { position: 5, label: "Living Room Outlets", amperage: 15, type: "single" as const, rooms: ["Living Room"], isMain: false },
    { position: 6, label: "Living Room Lights/Fan", amperage: 15, type: "single" as const, rooms: ["Living Room"], isMain: false },
    { position: 7, label: "Master Bedroom", amperage: 15, type: "single" as const, rooms: ["Master Bedroom"], isMain: false },
    { position: 8, label: "Master Bath GFCI", amperage: 20, type: "single" as const, rooms: ["Master Bathroom"], isMain: false },
    { position: 9, label: "Guest Bedroom", amperage: 15, type: "single" as const, rooms: ["Guest Bedroom"], isMain: false },
    { position: 10, label: "Guest Bath GFCI", amperage: 20, type: "single" as const, rooms: ["Guest Bathroom"], isMain: false },
    { position: 11, label: "Laundry Outlets", amperage: 20, type: "single" as const, rooms: ["Laundry Room"], isMain: false },
    { position: 12, label: "Washer", amperage: 20, type: "single" as const, rooms: ["Laundry Room"], isMain: false },
    { position: 13, label: "Dryer", amperage: 30, type: "double" as const, rooms: ["Laundry Room"], isMain: false, notes: "240V circuit" },
    { position: 15, label: "Water Heater", amperage: 30, type: "double" as const, rooms: ["Garage"], isMain: false, notes: "240V hybrid heat pump" },
    { position: 17, label: "HVAC / Air Handler", amperage: 40, type: "double" as const, rooms: ["Garage"], isMain: false },
    { position: 19, label: "AC Condenser", amperage: 40, type: "double" as const, rooms: [], isMain: false, notes: "Outdoor unit" },
    { position: 21, label: "Garage Outlets", amperage: 20, type: "single" as const, rooms: ["Garage"], isMain: false },
    { position: 22, label: "Garage Door Opener", amperage: 15, type: "single" as const, rooms: ["Garage"], isMain: false },
    { position: 23, label: "Outdoor Lights", amperage: 15, type: "single" as const, rooms: [], isMain: false },
    { position: 24, label: "Pool Pump", amperage: 20, type: "single" as const, rooms: [], isMain: false },
    { position: 25, label: "EV Charger Outlet", amperage: 50, type: "double" as const, rooms: ["Garage"], isMain: false, notes: "NEMA 14-50" },
    { position: 27, label: "Smoke/CO Detectors", amperage: 15, type: "single" as const, rooms: [], isMain: false },
    { position: 28, label: "Thermostat", amperage: 15, type: "single" as const, rooms: ["Living Room"], isMain: false },
  ],
};
